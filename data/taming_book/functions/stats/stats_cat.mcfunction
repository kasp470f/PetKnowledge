...
# Health
execute if entity @e[type=cat,sort=nearest,limit=1,tag=tamed] run tellraw @p [{"text":"Health: ","color":"gray"},{"nbt":"Health","entity":"@s", "color":"#FF8000"},{"text":" / ","color":"#FF8000"},{"nbt":"Attributes[1].Base","entity":"@s", "color":"#FF8000"}]

# Stats
execute if entity @e[type=cat,sort=nearest,limit=1,tag=tamed] run tellraw @p [{"text":"Attack Damage: ","color":"gray"},{"nbt":"Attributes[0].Base","entity":"@s", "color":"#FF8000"}]
execute if entity @e[type=cat,sort=nearest,limit=1,tag=tamed] run tellraw @p [{"text":"Movement Speed: ","color":"gray"},{"nbt":"Attributes[2].Base","entity":"@s", "color":"#FF8000"}]
