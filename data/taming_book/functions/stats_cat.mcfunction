...
## Health
execute if entity @e[type=cat,sort=nearest,limit=1,tag=tamed] run tellraw @p [{"text":"Health: ","color":"gray"},{"nbt":"Health","entity":"@e[type=cat,sort=nearest,limit=1,tag=tamed]", "color":"#FF8000"},{"text":" / ","color":"#FF8000"},{"text":"10d", "color":"#FF8000"}]
