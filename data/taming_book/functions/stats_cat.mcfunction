...
## Health
execute if entity @e[type=cat,sort=nearest,limit=1,tag=tamed] run tellraw @p [{"text":"Health: ","color":"gray"},{"nbt":"Health","entity":"@e[type=cat,sort=nearest,limit=1,tag=tamed] 5", "color":"#FF8000"}]